# saRsurv <img src="https://img.shields.io/badge/License-MIT-yellow.svg" alt="License: MIT"> <img src="https://img.shields.io/github/v/release/saraalmoqbali4-ops/saRsurv" alt="GitHub release">
...
You can install the development version of `saRsurv` directly from GitHub:

```r
# Install devtools if not installed
install.packages("devtools")

# Install saRsurv from GitHub
devtools::install_github("saraalmoqbali4-ops/saRsurv")
...
Author:
Sara Al-Moqbali
📧 saraalmoqbali4@gmail.com
Department of Statistics, Sultan Qaboos University
Creator and maintainer of the saRsurv package.
